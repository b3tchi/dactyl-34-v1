...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_5x4(
        ...
        KC_TAB               ,MT(MOD_LCTL,KC_1),MT(MOD_LALT,KC_EQL) ,KC_EXLM       ,MT(MOD_RGUI,KC_QUOT) ,KC_GT             ,KC_LEFT       ,TD(EXT_CTL)           ,KC_RCBR          ,KC_NO,
...
// --
// void on_ctlx_end(qk_tap_dance_state_t *state, void *user_data);
uint8_t ctlx_end_dance_step(qk_tap_dance_state_t *state);
void ctlx_end_finished(qk_tap_dance_state_t *state, void *user_data);
void ctlx_end_reset(qk_tap_dance_state_t *state, void *user_data);
...
void ctlx_end_finished(qk_tap_dance_state_t *state, void *user_data) {
    dance_state.step = ctlx_end_dance_step(state);
    switch (dance_state.step) {
...
qk_tap_dance_action_t tap_dance_actions[] = {
        ...
        [EXT_CTL] = ACTION_TAP_DANCE_FN_ADVANCED(NULL, ctlx_end_finished, ctlx_end_reset),
};
