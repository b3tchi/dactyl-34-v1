...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_5x4(
        ...
        KC_TAB               ,MT(MOD_LCTL,KC_1),MT(MOD_LALT,KC_EQL) ,KC_EXLM       ,MT(MOD_RGUI,KC_QUOT) ,TD(SYM_LGUI)      ,KC_LEFT       ,TD(SYM_LALT)      ,TD(SYM_LCTL)     ,KC_LBRC,
        KC_ESCAPE            ,KC_LT            ,KC_DOWN             ,KC_UP         ,KC_NO                ,KC_GT             ,KC_TAB        ,KC_RPRN           ,KC_RCBR          ,KC_RBRC,
