...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_5x4(
        TD(DANCE_1) ,KC_DOT      ,TD(DANCE_3)       ,KC_P              ,KC_Y ,KC_F ,KC_G              ,KC_C              ,KC_R ,KC_L ,
    ...
    [1] = LAYOUT_5x4(
        KC_ESCAPE ,KC_AT         ,KC_HASH    ,KC_DLR        ,KC_PERC      ,KC_CIRC      ,KC_AMPR       ,KC_ASTR       ,KC_COLN      ,KC_TILD  ,
        KC_TAB    ,KC_EXLM       ,KC_LT      ,KC_LPRN       ,KC_QUOT      ,KC_EQL       ,KC_LCBR       ,KC_LBRC       ,KC_PIPE      ,KC_ENTER ,
        KC_BSPC   ,KC_GRV        ,KC_LPRN    ,KC_RPRN       ,KC_DQT       ,KC_QUES      ,KC_LBRC       ,KC_RBRC       ,KC_BSLS      ,TO(3)    ,
    ...
    [2] = LAYOUT_5x4(
        ...
        KC_DEL    ,KC_KP_ASTERISK      ,KC_BRIGHTNESS_DOWN  ,KC_BRIGHTNESS_UP    ,KC_KP_DOT     ,KC_0    ,KC_1 ,KC_2 ,KC_3 ,KC_TRANSPARENT ,
        TO(0)     ,KC_LGUI             ,KC_RALT             ,TO(1)
    ),
    [3] = LAYOUT_5x4(
        TD(DANCE_54) ,KC_F9         ,KC_F10         ,KC_F11 ,KC_F12 ,KC_BRIGHTNESS_UP  ,KC_AUDIO_VOL_UP   ,KC_MEDIA_NEXT_TRACK  ,KC_MEDIA_PLAY_PAUSE ,KC_TRANSPARENT ,
        TD(DANCE_56) ,KC_F5         ,KC_F6          ,KC_F7  ,KC_F8  ,TD(DANCE_60)   ,MT(MOD_RGUI,KC_DOWN) ,MT(MOD_LALT,KC_UP) ,TD(DANCE_63)  ,KC_ENTER       ,
        TD(DANCE_58) ,KC_F1         ,KC_F2          ,KC_F3  ,KC_F4  ,KC_TRANSPARENT ,KC_MS_ACCEL0         ,KC_MS_ACCEL1       ,KC_MS_ACCEL2  ,KC_NO          ,
