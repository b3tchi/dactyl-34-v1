...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_5x4(
        ...
        KC_TAB    ,KC_EXLM       ,KC_LT      ,KC_LPRN       ,KC_EQL       ,KC_SCLN      ,KC_LEFT       ,KC_DOWN       ,KC_RGHT      ,KC_ENTER ,
    ...
    [2] = LAYOUT_5x4(
        ...
        KC_TAB    ,KC_EXLM             ,KC_LT               ,KC_LPRN             ,KC_EQL        ,KC_EQL  ,KC_4 ,KC_5 ,KC_6 ,KC_ENTER       ,
        KC_DEL    ,KC_ASTR             ,KC_BRIGHTNESS_DOWN  ,KC_BRIGHTNESS_UP    ,KC_KP_DOT     ,KC_0    ,KC_1 ,KC_2 ,KC_3 ,KC_LGUI        ,
